    ...
    <div className="w-full py-10">
      <div className="text-center mb-16 sm:mb-20">
        ...
        <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-gray-900 tracking-tighter uppercase leading-[0.95] mb-8">
          See the <span className="text-blue-600">AI Magic</span>{" "}
        ...
        <div className="flex flex-wrap justify-center gap-3 px-4">
          {[
            ...
            <div
              key={i}
              className="bg-white border border-gray-100 px-4 py-2 rounded-2xl shadow-sm flex items-center gap-2"
            >
        ...
        <div className="p-8 sm:p-14 space-y-12">
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 group">
            <div className="sm:w-24 shrink-0 flex flex-col items-center sm:items-start">
              <span className="text-xs font-black text-blue-600 uppercase tracking-widest leading-none">
                Day
              </span>
              <span className="text-5xl font-black text-gray-100 group-hover:text-blue-50 transition-colors">
                01
              </span>
            </div>
            <div className="flex-1 space-y-4 pt-1 border-l-2 border-gray-50 pl-8 relative">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-start gap-3 text-gray-500 text-sm sm:text-base font-medium"
                  >
          ...
          <div className="bg-blue-600 rounded-[2rem] p-6 sm:p-8 flex items-start gap-5 shadow-xl shadow-blue-100">
            ...
            <div className="space-y-1 text-left">
              ...
              <p className="text-sm sm:text-base text-white font-bold leading-relaxed">
                "I've moved Fort Aguada to 8:00 AM. Based on real-time data,
                crowd density increases by 65% after 10:30 AM."
              </p>
            </div>
          </div>
        </div>
