...
const Navbar = () => {
  return (
    // Responsive Margin: mobile par kam, desktop par zyada
    <nav className="sticky top-4 z-50 mx-4 sm:mx-8 lg:mx-12">
      <div className="max-w-7xl mx-auto bg-white/70 backdrop-blur-xl border border-white/20 rounded-[1.5rem] shadow-2xl shadow-blue-100/20">
        <div className="px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          {/* Logo Section - Side by Side style */}
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="hidden sm:flex flex-col">
              ...
              <div className="flex items-center gap-1 mt-0.5">
                ...
                <span className="text-[7px] text-gray-400 font-bold uppercase tracking-[0.2em]">Smart Trips</span>
              </div>
            </div>
          </Link>

          {/* Navigation Links - Minimalist Caps Style */}
